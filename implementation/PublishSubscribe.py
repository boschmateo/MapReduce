...
class Registry(object):
    ...
    def mapreduce(self, mapClass, reduceClass, httpServer, nMappers, fileName):
    	#Split the file
    	self.splitFile(fileName, nMappers)
...
if __name__ == "__main:__":
    ...
    registry.mapreduce("mapCW/Map", "reduceCW/Reduce", IP_MASTER+":8000", 2, 'books/bible.txt')
